...
const ItemsShow = () => {
    ...
    return ((0, jsx_runtime_1.jsxs)(Main_1.Main, { children: [(0, jsx_runtime_1.jsx)(Sidebar_1.Sidebar, { children: (0, jsx_runtime_1.jsx)(SidebarContents_1.SidebarContents, { isStateOpen: isStateOpen, handleMobileClose: handleMobileClose }) }), (0, jsx_runtime_1.jsx)(Contents_1.Contents, { children: id && item ? ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsx)(Header_1.Header, { handleMobileOpen: handleMobileOpen, isItemPublishable: item.modified && item.errorMessages.length === 0, itemPath: item.itemPath, id: id, basename: basename }), (0, jsx_runtime_1.jsx)("div", { css: contentsWrapperStyle, children: (0, jsx_runtime_1.jsxs)("div", { css: contentsContainerStyle, children: [(0, jsx_runtime_1.jsx)(ArticleInfo_1.ArticleInfo, { secret: item.private, modified: item.modified, organizationUrlName: item.organizationUrlName, published: item.published, errorMessages: item.errorMessages, qiitaItemUrl: item.qiitaItemUrl }), (0, jsx_runtime_1.jsx)("div", { css: articleWrapStyle, children: (0, jsx_runtime_1.jsx)(Article_1.Article, { renderedBody: item.renderedBody, tags: item.tags, title: item.title }) })] }) })] })) : error ? ((0, jsx_runtime_1.jsx)("p", { css: errorMessageStyle, children: error })) : errorFrontmatterMessages && errorFrontmatterMessages.length > 0 ? ((0, jsx_runtime_1.jsxs)("div", { css: errorContentsStyle, children: [(0, jsx_runtime_1.jsx)("p", { css: errorTitleStyle, children: "\u8A18\u4E8B\u306E\u8A2D\u5B9A\u306E\u5165\u529B\u5185\u5BB9\u306B\u8AA4\u308A\u304C\u3042\u308B\u305F\u3081\u3001\u30D7\u30EC\u30D3\u30E5\u30FC\u304C\u8868\u793A\u3067\u304D\u307E\u305B\u3093" }), errorFrontmatterMessages.map((errorMessage, index) => ((0, jsx_runtime_1.jsxs)("p", { css: errorStyle, children: [(0, jsx_runtime_1.jsx)(MaterialSymbol_1.MaterialSymbol, { fill: true, css: exclamationIconStyle, children: "error" }), errorMessage] }, `error-message-${index}`)))] })) : null })] }));
};
