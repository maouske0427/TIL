...
class FileContent {
    constructor({ title, tags, secret, updatedAt, id, organizationUrlName, rawBody, }) {
        this.title = title;
        this.tags = tags;
        this.secret = secret;
...
class FileSystemRepo {
    ...
    defaultBasename(fileContent, _remote) {
    ...
    async setItemData(fileContent, remote = false, basename = null) {
        ...
        const filepath = this.getFilePath(basename || this.defaultBasename(fileContent, remote), remote);
    ...
    async syncItem(item, beforeSync = false, isLocalUpdate = false) {
    ...
    async saveItem(item, beforeSync = false, isLocalUpdate = false) {
